                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form">
                            <div class="form-group">
                                ...
                                <input type="email" name="emaillog" id="emaillog" placeholder="Email" required="required" />
                            </div>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="passwordlog" id="passwordlog" placeholder="Password" required="required" />
                            </div>
                            <div class="form-group">
