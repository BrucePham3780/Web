                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>Managerment</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="coachman.php">Coach</a>
                                </li>
                                <li>
                                    <a href="classman.php">Class</a>
                                </li>
                                <li>
                                    <a href="userman.php">List User</a>
                                </li>
                                <li>
