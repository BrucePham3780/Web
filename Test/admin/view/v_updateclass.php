...
{ 
	if(isset($_POST['name']) && isset($_POST['image']) && isset($_POST['detail']))
	{
		...
		$cclass->postUpdateClass($name, $image, $detail, $id);
	}
}
else
{
            ...
            <form role="form" action="#" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" id="exampleInputEmail1"  value="<?=$class->className?>">
                </div>
                ...
                <div class="form-group">
                  <label>Detail</label>
                  <textarea name="detail" class="form-control" rows="5" placeholder="Detail"><?=$class->classDetail?></textarea>
                </div>
              </div>
              <!-- /.box-body -->
